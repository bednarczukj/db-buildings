...
describe('TerytService', () => {
  ...
  describe('getTerytEntries', () => {
    ...
    it.skip('should handle database errors', async () => {
      ...
      await expect(service.getTerytEntries('communities', { page: 1, pageSize: 10 }))
        .rejects
        .toThrow('Failed to fetch communities: Database connection failed');
    });
  ...
  describe('getTerytEntry', () => {
    ...
    it('should throw error for non-existent entry', async () => {
      ...
      await expect(service.getTerytEntry('communities', '9999999'))
        .rejects
        .toThrow('communitie with code 9999999 not found');
    });
  });
  ...
  describe('createTerytEntry', () => {
    ...
    it.skip('should throw error for duplicate code', async () => {
      ...
      await expect(service.createTerytEntry('communities', {
        code: '1465011',
        name: 'Warszawa',
        district_code: '1465000',
  ...
  describe('updateTerytEntry', () => {
    ...
    it('should throw error for non-existent entry', async () => {
      ...
      await expect(service.updateTerytEntry('communities', '9999999', { name: 'Test' }))
        .rejects
        .toThrow('communitie with code 9999999 not found');
    });
  });
  ...
  describe('deleteTerytEntry', () => {
    ...
    it('should throw error for non-existent entry', async () => {
      ...
      await expect(service.deleteTerytEntry('communities', '9999999'))
        .rejects
        .toThrow('communitie with code 9999999 not found');
    });
  });
